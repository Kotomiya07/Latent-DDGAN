...
if [[ $MODE == train ]]; then
	...
	if [[ $DATASET == cifar10 ]]; then
		...
		python3 train_ldgan_lab.py --dataset coco_256 --image_size 256 --exp g12222_128_2block_d4_attn16_nz50 --num_channels 3 --num_channels_dae 128 --ch_mult 1 2 2 2 --num_timesteps 2 \
